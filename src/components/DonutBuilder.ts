...
export default class DonutBuilder {
        ...
        public Build() : Drawing {
            ...
            .AddLayer(
                new Layer("toggle")
                .AddTag("toggle")
                .AddGeometry(new PolylineBuilder([.95,.05]).VerticalTo(0.1).HorizontalTo(0.9).VerticalTo(0.05).HorizontalTo(0.95).Build().AddTag("toggle-click"))
                .AddGeometry(new PolylineBuilder([.95,.05]).VerticalTo(0.1).LineTo([0.9, 0.05]).HorizontalTo(.95).Build().AddTag("toggle-fill"))
            );
            ...
            .AddStyle(
                new StyleBuilder("toggle-bw")
                .Fill("#ffffff")
                .Stroke("#000000")
                .StrokeWidth("2px")
                .Build()
            )
            .Target("toggle-bw", "toggle")
            .AddStyle(
                new StyleBuilder("toggle-bw-fill")
                .Fill("#000000")
                .StrokeWidth("0px")
                .Build()
            )
            .Target("toggle-bw-fill", "toggle-fill");
